...
<%
	...
	String note_picture = request.getParameter("note_picture");
	...
	file2StringUtil.byte2Image(note_picture, time);//存图片
	...
	//String note_title ="free";
	//String note_content ="frr";
	note.setNote_title(note_title);
	note.setNote_content(note_content);
	note.setNote_picture(note_picture);
	flag = addnote.Add_Note(note_title, note_content, time1, date);
