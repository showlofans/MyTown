...
<%
  ...
  String group_title=request.getParameter("group_title").trim();//标题
  String group_content=request.getParameter("group_content").trim(); //内容
  ...
  AddGroup aw=new AddGroup(); 
  String k=aw.Add_Group(group_title,group_content);
  if(k.equals("sucess"))
  {
    out.print("发表成功!!");
  }else{
