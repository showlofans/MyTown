...
<%
  ...
  String cultivation_title=request.getParameter("cultivation_title").trim();//标题
  String cultivation_content=request.getParameter("cultivation_content").trim(); //内容
  ...
  AddCultivation aw=new AddCultivation(); 
  String k=aw.Add_Cultivation(cultivation_title,cultivation_content);
  if(k.equals("sucess"))
  {
    out.print("发表成功!!");
  }else{
